...
TRANS_TO_POLAR_MESSAGE: str = "Your next function is polar and needs to be drawn on a polar " \
                              "coordinate axis. Do you want to create a new coordinate axis and draw it? choose " \
                              "CANCEL will abort the process."
...
class Christopher:
    ...
    def process_2d_polar_equ(equation: str) -> str:
        ...
        return Christopher.process_2d_equ(equation)
    ...
    def __plot_vectors_3d(self,
        ...
        for plot_index in range(len(vector)):
            ...
            x_, y_, z_ = numpy.meshgrid(self.__get_index(cur_start_at, 0, 0),
            ...
            self.ax.quiver(x_, y_, z_, x, y, z, color=self.colour.get_poolobj_value(), arrow_length_ratio=0.2,
                           alpha=get_config("alpha"))
